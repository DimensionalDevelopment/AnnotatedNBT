...
@SupportedAnnotationTypes("org.dimdev.annotatednbt.NBTSerializable")
@SupportedSourceVersion(SourceVersion.RELEASE_8)
public class NBTSerializableProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) { // TODO: generics, inheritance, different exception for error type
        for (Element element : roundEnv.getElementsAnnotatedWith(NBTSerializable.class)) {
            ...
            for (Element enclosedElement : classElement.getEnclosedElements()) {
                if (enclosedElement.getKind() == ElementKind.FIELD && enclosedElement.getAnnotationsByType(Saved.class).length > 0) {
            ...
            case DECLARED:
                ...
                switch (declaredType.toString()) {
                    ...
                    case STRING:
                        ...
                        break;
                    case UUID:
                        w.println("nbt.setUniqueId(\"" + name + "\", obj." + name + ");");
                        break;
                    default:
            ...
            case DECLARED:
                ...
                switch (declaredType.toString()) {
                    ...
                    case UUID: // TODO: non top-level UUIDs
                        w.println("obj." + name + " = nbt.getUniqueId(\"" + name + "\");");
                        break;
                    default:
                        if (tu.isAssignable(type, eu.getTypeElement(NBT_STORABLE).asType())) {
